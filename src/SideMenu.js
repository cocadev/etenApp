        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <View style={{ backgroundColor: '#fff', paddingLeft: width / 12 }}>
                    <TouchableOpacity style={styles.menu} onPress={() => Actions.home()} >
                    ...
                    <TouchableOpacity style={styles.menu}>
                        ...
                        <Text style={[text.m_15_dark, { marginLeft: 22 }]}>NEED HELP</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.menu} onPress={() => Actions.language()}>
                        <Image source={images.icon_setting} style={{ width: 18, height: 18 }} />
                        <Text style={[text.m_15_dark, { marginLeft: 22 }]}>CHANGE LANGUAGE</Text>
                    </TouchableOpacity>
